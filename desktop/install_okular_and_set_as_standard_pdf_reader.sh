...
mkdir -p /home/.skjult/.config

cat << EOF > /home/.skjult/.config/mimeapps.list
...
cat << EOF > /home/.skjult/.config/okularpartrc
...
mkdir -p /home/.skjult/.local/share/kxmlgui5/okular/

cat << EOF > /home/.skjult/.local/share/kxmlgui5/okular/part.rc
