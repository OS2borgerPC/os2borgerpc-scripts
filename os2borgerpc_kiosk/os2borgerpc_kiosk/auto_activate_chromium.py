...
# """
# Activates an OS2display screen and runs Chromium in fullscreen.
...
print("Installed selenium, and plyvel.")

# Ignore E402 module level import not at top of file
# because they aren't at the top because they haven't been installed yet.
...
from selenium.webdriver.support import expected_conditions as expected  # noqa: E402
...
wait.until(expected.visibility_of_element_located((By.TAG_NAME, "input"))).send_keys(
    "" + activation_code + Keys.ENTER
)

try:
    WebDriverWait(browser, 3).until(
        expected.alert_is_present(), "Timed out waiting for alert."
    )
...
subprocess.call(
    [
        ...
        "-R",
        f"{username}:{username}",
        "/home/chrome/snap/chromium/common/chromium/Default/Local Storage/leveldb",
    ]
)
